    ...
    <div class="card-form">
                  ...
                  <transition name="slide-fade-up">
                    <div v-if="cardName.length" key="1" class="card-item__name">
                      <transition-group name="slide-fade-right">
                        <span v-for="(n, $index) in cardName.replace(/\s\s+/g, ' ')" v-if="$index === $index" :key="$index + 1" class="card-item__nameItem">{{ n }}</span>
                      </transition-group>
                    </div>
      ...
      <div class="card-form__inner">
        <div class="card-input">
          ...
          <input id="cardNumber" v-model="cardNumber" v-mask="generateCardNumberMask" type="text" class="card-input__input" data-ref="cardNumber" autocomplete="off" v-on:focus="focusInput" v-on:blur="blurInput">
        </div>
        <div class="card-input">
          <label for="cardName" class="card-input__label">Card Holders</label>
          <input id="cardName" v-model="cardName" type="text" class="card-input__input" data-ref="cardName" autocomplete="off" v-on:focus="focusInput" v-on:blur="blurInput">
        </div>
        <div class="card-form__row">
          <div class="card-form__col">
            <div class="card-form__group">
              <label for="cardMonth" class="card-input__label">Expiration Date</label>
              <select id="cardMonth" v-model="cardMonth" class="card-input__input -select" data-ref="cardDate" v-on:focus="focusInput" v-on:blur="blurInput">
                <option value="" disabled selected>Month</option>
                <option v-for="n in 12" :key="n" :value="n < 10 ? '0' + n : n" :disabled="n < minCardMonth">
                  {{ n < 10 ? '0' + n : n }}
                </option>
              </select>
              <select id="cardYear" v-model="cardYear" class="card-input__input -select" data-ref="cardDate" v-on:focus="focusInput" v-on:blur="blurInput">
          ...
          <div class="card-form__col -cvv">
            <div class="card-input">
              ...
              <input id="cardCvv" v-model="cardCvv" v-mask="'####'" type="text" class="card-input__input" maxlength="4" autocomplete="off" v-on:focus="flipCard(true)" v-on:blur="flipCard(false)">
            </div>
          </div>
        </div>
