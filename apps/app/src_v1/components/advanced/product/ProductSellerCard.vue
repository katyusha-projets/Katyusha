...
import { viaPlaceholderErrorHandler } from '@utils/viaPlaceholderErrorHandler'

interface ProductSellerItem {
  preview: string
}
...
interface ProductSeller {
  ...
  picture: string
  url: string
  items: ProductSellerItem[]
}

interface ProductSellerCardProps {
  content: ProductSeller
  flat?: boolean
}

const props = withDefaults(defineProps<ProductSellerCardProps>(), {
  flat: false
})
