  ...
  <main>
    <div class="main main_channel js-main">
      <div class="main__container">
        <div class="main__item" style="background-image: url(&quot;img/main-pic-1.png&quot;);"><div class="main__details"><div class="main__live live live_big">Live</div><div class="main__title h4">Renegades vs Chiefs - ESL Pro League Season 16</div><div class="main__parameters"><div class="main__parameter"><div class="main__icon"><img class="main__pic" src="img/league-of-legends.png" alt=""></div><div class="main__text">League of Legends®</div></div><div class="main__parameter">🇺🇸 English</div></div><a class="main__btn btn btn_purple" href="video-live.html" tabindex="0">Watch Now</a></div></div>
      </div>
    </div>
        ...
        <div class="author__container">
          <div class="author__details">
            <div class="ava ava_online">
              <img class="ava__pic" src="img/ava-1.png" alt="">
            </div>
            <div class="author__wrap">
              <div class="author__man h2 confirm">Dylan Hodges</div>
