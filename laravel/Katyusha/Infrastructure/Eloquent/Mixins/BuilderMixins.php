 ...
 ******************** Relations
 *
 * @method Builder|BelongsToMany belongsToMany($related, $table = null, $foreignPivotKey = null, $relatedPivotKey = null, $parentKey = null, $relatedKey = null, $relation = null)
 * @method Builder|HasMany       hasMany($related, $foreignKey = null, $localKey = null)
 ******************** Others
 * @method                    Collectionunique($key = null, $strict = false)
 ...
 * @method static Model|mixed sole(array $columns = ['*'])Execute the query and get the first result or throw an exception.
 * @method static Model|mixed first(array $columns = ['*']) Execute the query and get the first result or throw an exception.
