...
use Katyusha\Framework\Utilities\Time;
...
use Katyusha\Applications\Economics\Types\Numerical\SafeNumber;
use Katyusha\Drivers\Payment\Responses\CheckoutRequestResponse;
use Katyusha\Drivers\Payment\Consignments\PaymentRequestContract;
...
use Katyusha\Drivers\Payment\Consignments\VippsPaymentServiceContract;
...
final class VippsDriver implements PaymentDriverContract {
    ...
    public function __construct(protected VippsPaymentServiceContract $apiConsignment, protected PaymentRequestContract $paymentRequestConsignment) {
