...
return [
    ...
    'receipt_data' => [
        'vendor'   => env('SPARK_VENDOR', 'Your Product'),
        'product'  => env('SPARK_PRODUCT', 'Your Product'),
        'street'   => env('SPARK_STREET', '111 Example St.'),
        'location' => env('SPARK_LOCATION', 'Los Angeles, CA'),
        'phone'    => env('SPARK_PHONE', '555-555-5555'),
    ],
        ...
        'user' => [
            ...
            'plans' => [
                [
                    ...
                    'short_description' => 'A full subscription to '.env('APP_NAME').' giving access to all our features',
                    'monthly_id'        => 'price_1LgSIbHZvSN3EXJ3jXAv2Yfy',
                    'yearly_id'         => 'price_1LgSJAHZvSN3EXJ3f4pf5Sj1',
                    'features'          => [
                        'Full historic data on any company ticker',
                        'Dashboards, filtering, and analytics',
                        'Powerful filters and AI tools',
                    ],
                ],
            ],
