...
class Form {
    ...
    public function displayOwner(): self {
        $this->fields[] = BelongsTo::make('Created By', 'user', config('nova.resource_owner_class'))->readonly();
    ...
    public function belongsToMany(string $title, string $relationClass, ?bool $nullable = false, ?string $key = null): self {
        ...
        $this->fields[] = BelongsToMany::make($title, $key ?: $this->key($title), $relationClass)->exceptOnForms();
